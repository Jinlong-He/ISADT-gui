...
namespace isadt{
		...
		void  CCodeGenerator::generateHeaderFileWin(std::string path, Process* proc)
        {
            std::ofstream outHeadFile;
		    //TODO: make sure here
		    std::string tempFileName = proc->getName() + ".h";
        ...
        std::string  CCodeGenerator::generateCommonIncludesWin()
        {
            std::string commonIncludes =
			"#include <iostream>\n#include <string>\n#include <vector>\n#include <stdlib.h>\n#include <thread>\n#include <stdlib.h>\n#include <sstream>\n";
		    commonIncludes += INCLUDE_HEADER;
		...
		void CCodeGenerator::generateUserTypesWin(std::string path, Model* model)
		{
			std::ofstream outUserTypeFile;
		    //TODO: make sure here
		    std::string fileName = "UserType.hpp";
		...
		void CCodeGenerator::generateCompileFileWin(std::string path, Model* model)
		{
			std::ofstream outCompileFile;
			std::cout << "generate compile auxiliary" << std::endl;
			std::string outStr = "import os\n";
		...
		void CCodeGenerator::generateCodeProcWin(std::string path, Process* proc){
		...
		void CCodeGenerator::generateAllWin(std::string path, Model* model){
