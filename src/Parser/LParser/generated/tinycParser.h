...
public:
  ...
  enum {
    ...
    RuleRelationalExpression = 6, RuleEqualityExpression = 7, RuleLogicalAndExpression = 8, 
    RuleLogicalOrExpression = 9, RuleAssignmentExpression = 10, RuleDeclaration = 11, 
    RuleInitDeclaratorList = 12, RuleInitDeclarator = 13, RuleDeclarator = 14, 
    RuleInitializer = 15, RuleInitializerList = 16, RuleStatement = 17
  };
