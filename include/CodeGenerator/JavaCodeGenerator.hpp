#ifndef CodeGenerator_JavaCodeGenerator_hpp
#define CodeGenerator_JavaCodeGenerator_hpp
...
namespace isadt 
{
    class JavaCodeGenerator : public ImpleCodeGenerator 
    {
    private:
